...
$_lang['visax.many_time'] = 'Многозазовая';
...
/* Used in visax.form.js */
// $_lang['visax.empty'] = '';
// $_lang['visax.sess_list'] = '';
// $_lang['visax.country_name'] = '';
// $_lang['visax.persons_count'] = '';
// $_lang['visax.state'] = '';
// $_lang['visax.load_sess'] = '';
// $_lang['visax.load_confirm'] = '';
// $_lang['visax.new_sess_start'] = '';
// $_lang['visax.drop_zone'] = '';
// $_lang['visax.visax_title'] = '';
// $_lang['visax.sessions'] = '';
// $_lang['visax.step_1'] = '';
// $_lang['visax.step_2'] = '';
// $_lang['visax.step_3'] = '';
// $_lang['visax.country'] = '';
// $_lang['visax.country_pls'] = '';
// $_lang['visax.country_cmnt'] = '';
// $_lang['visax.country_inv'] = '';
// $_lang['visax.persons_count_pls'] = '';
// $_lang['visax.persons_count_cmnt'] = '';
// $_lang['visax.persons_count_inv'] = '';
// $_lang['visax.phone'] = '';
// $_lang['visax.email_pls'] = '';
// $_lang['visax.clear'] = '';
// $_lang['visax.continue'] = '';
// $_lang['visax.invalid_form'] = '';
// $_lang['visax.sirname'] = '';
// $_lang['visax.sirname_pls'] = '';
// $_lang['visax.firstname'] = '';
// $_lang['visax.firstname_pls'] = '';
// $_lang['visax.patronymic'] = '';
// $_lang['visax.birth_date'] = '';
// $_lang['visax.birth_date_pls'] = '';
// $_lang['visax.parents_group'] = '';
// $_lang['visax.mother_fio'] = '';
// $_lang['visax.mother_fio_pls'] = '';
// $_lang['visax.mother_phone'] = '';
// $_lang['visax.mother_phone_pls'] = '';
// $_lang['visax.mother_address'] = '';
// $_lang['visax.mother_address_pls'] = '';
// $_lang['visax.father_fio'] = '';
// $_lang['visax.father_fio_pls'] = '';
// $_lang['visax.father_phone'] = '';
// $_lang['visax.father_phone_pls'] = '';
// $_lang['visax.father_address'] = '';
// $_lang['visax.father_address_pls'] = '';
// $_lang['visax.trip_target'] = '';
// $_lang['visax.trip_target_pls'] = '';
// $_lang['visax.visa_type'] = '';
// $_lang['visax.visa_type_pls'] = '';
// $_lang['visax.one_time'] = '';
// $_lang['visax.many_time'] = '';
// $_lang['visax.prev_surnames'] = '';
// $_lang['visax.prev_surnames_pls'] = '';
// $_lang['visax.marital_status'] = '';
// $_lang['visax.marital_status_pls'] = '';
// $_lang['visax.no_married'] = '';
// $_lang['visax.married'] = '';
// $_lang['visax.registration_region'] = '';
// $_lang['visax.registration_region_pls'] = '';
// $_lang['visax.registration_region_inv'] = '';
// $_lang['visax.registration_address'] = '';
// $_lang['visax.registration_address_pls'] = '';
// $_lang['visax.residential_address'] = '';
// $_lang['visax.residential_address_pls'] = '';
// $_lang['visax.employment'] = '';
// $_lang['visax.employment_pls'] = '';
// $_lang['visax.work'] = '';
// $_lang['visax.vuz'] = '';
// $_lang['visax.school'] = '';
// $_lang['visax.not_work'] = '';
// $_lang['visax.pension'] = '';
// $_lang['visax.employment_group'] = '';
// $_lang['visax.empl_function'] = '';
// $_lang['visax.empl_function_pls'] = '';
// $_lang['visax.empl_address'] = '';
// $_lang['visax.empl_address_pls'] = '';
// $_lang['visax.empl_phone'] = '';
// $_lang['visax.empl_phone_pls'] = '';
// $_lang['visax.last_visa'] = '';
// $_lang['visax.desired_time'] = '';
// $_lang['visax.desired_time_pls'] = '';
// $_lang['visax.price'] = '';
// $_lang['visax.person_add'] = '';
// $_lang['visax.person_remove'] = '';
// $_lang['visax.person_info'] = '';
// $_lang['visax.session'] = '';
// $_lang['visax.url_hash'] = '';
